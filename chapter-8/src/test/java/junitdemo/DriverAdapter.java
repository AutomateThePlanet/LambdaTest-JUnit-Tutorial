...
public class DriverAdapter {
    ...
    public void start(Browser browser, String testName, String countryCode) {
        ...
        ltOptions.put("geoLocation",countryCode);
    ...
    public void addCookie(String name, String value) {
        webDriver.get().manage().addCookie(new Cookie(name, value));
    }
    ...
    public WebElement findElement(By locator){
        var element = webDriverWait.get().until(ExpectedConditions.presenceOfElementLocated(locator));
